...
def dataloader(filepath, returnCalib=False, trainAll=False):
    train_list_f = open('/content/coex/dataloaders/stereo/lists/kitti2015_train180.list', 'r')
    test_list_f = open('/content/coex/dataloaders/stereo/lists/kitti2015_val20.list', 'r')
